...
export interface ChannelContract {
  ...
  'cli:health': [[provider: string, connectionType: string, ssh?: SshConfig | null, wsl?: WslConfig | null], CliHealthResult]
  'cli:update': [[provider: string, connectionType: string, ssh?: SshConfig | null, wsl?: WslConfig | null], CliUpdateResult]
  'models:claudeAvailable': [[threadId?: string | null, forceRefresh?: boolean], ModelOption[]]
  'models:codexAvailable': [[threadId?: string | null, forceRefresh?: boolean], ModelOption[]]
  'models:opencodeAvailable': [[threadId?: string | null, forceRefresh?: boolean], ModelOption[]]
  'models:piAvailable': [[threadId?: string | null, forceRefresh?: boolean], ModelOption[]]
  'models:cursorAvailable': [[threadId?: string | null, forceRefresh?: boolean], ModelOption[]]
  'models:grokAvailable': [[threadId?: string | null, forceRefresh?: boolean], ModelOption[]]
  'models:kimiAvailable': [[threadId?: string | null, forceRefresh?: boolean], ModelOption[]]
